...
import MediaUploadButton from './media-upload-buttons'
import {
  Command,
  CommandEmpty,
  CommandGroup,
...
// Define the structure of a media file
type MediaFile = {
  id: string
  name: string
  link: string
...
// Define the structure of GetMediaFiles
type GetMediaFiles = {
  Media: MediaFile[]
}
